...
// OpenSSL 1.1.0+ handles threading automatically; the manual callback API was
// deprecated in 1.1.0 and removed/no-op in 3.0.
...
#else
  return (unsigned long)(&fc::thread::current());
#endif
}
